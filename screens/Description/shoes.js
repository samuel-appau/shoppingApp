  ...
  return (
         ...
         <View style={{marginLeft:70}}>
          <Ionicons
                    ...
                    onPress={()=>navigation.navigate('payment',{arr:cart})}
                />
    ...
    <ScrollView>
      {products.map(product=>{
       ...
       <Image  style={{backgroundColor:"#000",height:162,width:"90%",marginTop:10}} source={require('../../assets/images/phones/motorola-charm.jpg')}  />
          <View style={{flexDirection:'column',flex:2}}>
             
            <Text style={{fontSize:20,fontWeight:'bold'}}>
                 {product.name}
            </Text>
            <Text style={{fontSize:21,color:"red",fontWeight:'bold',marginLeft:70}}>
               ${product.price}
            </Text>
             </View>
         <View style={{flex:5,marginRight:-26,marginBottom:-30,marginTop:20}}>
           <View  style={{backgroundColor:"blue",borderRadius:10,marginLeft:-25}}>
