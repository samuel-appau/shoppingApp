    ...
    <ScrollView>
      {products.map(product=>{
        return(
          ...
          <View key={product.age}  style={{height:260,width:"90%", borderRadius:10,marginLeft:20, 
              marginVertical:10,
              alignItems:'center',
          ...
          <View  style={{flex:8}}>
             <Image  style={{backgroundColor:"#000",height:120,width:"90%"}} source={{uri:product.imageUrl}}  />
          </View>
